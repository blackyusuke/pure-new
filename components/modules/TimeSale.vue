...
.time-sale .count-down .limited {
  @apply text-fz34 leading-lh49 font-bold text-white;
}
.time-sale .count-down time {
  @apply text-fz34 leading-lh49 font-bold;
  color: theme("colors.light-yellow");
}
.time-sale .count-down img {
  @apply mx-16;
}
